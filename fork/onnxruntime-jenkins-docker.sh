...
export CIBW_BEFORE_BUILD="pip install pybind11 cython numpy scipy pyquickhelper scikit-learn pandas pandas_streaming onnx && python ./tools/ci_build/build.py --gen_doc validate --build_dir ./build/debian --config RelWithDebInfo --build_wheel --numpy_version= --skip_tests --build_shared_lib"
