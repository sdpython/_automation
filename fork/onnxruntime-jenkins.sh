...
python ./tools/ci_build/build.py --gen_doc 1 --build_dir ./build/debian --config Release --build_wheel --numpy_version= --skip_tests --build_shared_lib --enable_training --enable_training_ops --enable_training_apis --parallel 3 || exit 1
