...
echo python ./tools/ci_build/build.py --build_dir ./build/debian --config Release --gen_doc --build_wheel --use_openmp --numpy_version= --skip-keras-test --skip_onnx_tests || exit 1
python ./tools/ci_build/build.py --build_dir ./build/debian --config Release --gen_doc --build_wheel --use_openmp --numpy_version= --skip-keras-test --skip_onnx_tests --build_shared_lib || exit 1
