...
echo python ./tools/ci_build/build.py --build_dir ./build/debian --config Release --gen_doc validate --build_wheel --use_openmp --numpy_version= --skip-keras-test --skip_onnx_tests || exit 1
