...
dotnet test Microsoft.ML.sln -c Release --filter "FullyQualifiedName~Microsoft.ML.CodeAnalyzer" || exit 1
...
dotnet test Microsoft.ML.sln -c Release --filter "FullyQualifiedName~Microsoft.ML.OnnxTransformTest" || exit 1
dotnet test Microsoft.ML.sln -c Release --filter "FullyQualifiedName~Microsoft.ML.Predictor" || exit 1
...
dotnet test Microsoft.ML.sln -c Release --filter "FullyQualifiedName~Microsoft.ML.TestFramework" || exit 1
...
dotnet test Microsoft.ML.sln -c Debug --filter "FullyQualifiedName~Microsoft.ML.CodeAnalyzer" || exit 1
...
dotnet test Microsoft.ML.sln -c Debug --filter "FullyQualifiedName~Microsoft.ML.OnnxTransformTest" || exit 1
dotnet test Microsoft.ML.sln -c Debug --filter "FullyQualifiedName~Microsoft.ML.Predictor" || exit 1
...
dotnet test Microsoft.ML.sln -c Debug --filter "FullyQualifiedName~Microsoft.ML.TestFramework" || exit 1
